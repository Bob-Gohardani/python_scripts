...
modification.
AKA: don't hard code then edit, extend the class instead via inheritance
"""
...
Snake, We have to modify the animal_sound function. for every new
...
"""
This fails the OCP principle. OCP forbids it. If we want to give a new
